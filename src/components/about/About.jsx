        ...
        <section id="about" className="about">
            <div className="about__content">
                ...
                <p className="about__paragraph">
                    Im a software developer with a strong passion for building user-friendly and efficient web applications. I specialize in modern technologies such as React, Node.js, and UI/UX design, and I’m always focused on delivering clean, responsive, and accessible solutions.
                </p>
                <p className="about__paragraph">
